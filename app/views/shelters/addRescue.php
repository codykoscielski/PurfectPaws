    ...
    <div class="flex h-full">
        ...
        <div class="main-content ml-20 md:ml-64 p-8">
            ...
            <div class="flex items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-cat ml-3 mb-5" width="30" height="30" viewBox="0 0 24 24" stroke-width="2" stroke="#F77B6E" fill="none" stroke-linecap="round" stroke-linejoin="round">
