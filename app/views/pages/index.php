...
<div class="hero bg-center bg-cover h-[450px] lg:h-[600px] flex items-center lg:items-center justify-center lg:justify-start lg:pl-10p" style="background-image: url('<?= URLROOT ?>/images/hero-image.png');">
    <div class="text-section">
        ...
        <button class="btn bg-muted-coral text-white font-bold px-6 py-3 rounded-full hover:bg-pastel-orange transition duration-200">Discover Your Purr-Fect Match</button>
    </div>
</div>
...
<section class="adoption-about mt-5 container mx-auto px-4">
    ...
    <div class="flex max-w-section mx-auto">
        <div>
            ...
            <div>
                <button class="mt-4 inline-flex items-center bg-muted-coral hover:bg-dusty-teal text-white font-bold py-2 px-4 rounded transition duration-200">Adoptions</button>
