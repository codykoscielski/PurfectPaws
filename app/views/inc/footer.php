    ...
    <div class="flex w-full p-6 mx-auto justify-evenly items-center">
        <div class="flex flex-col">
            ...
            <div class="flex">
                ...
                <img src="<?= URLROOT ?>/images/linkedin.svg" alt="facebook logo">
        ...
        <div class="flex-item">
            <ul>
                ...
                <li class="font-amatic text-[32px] text-soft-cream"><a href="">Adoption</a></li>
                <li class="font-amatic text-[32px] text-soft-cream"><a href="">Donate</a></li>
